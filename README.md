...
- analyzing a second spatial dataset with custom coordinates
...
Based on the Scanpy tutorial:  
**10x Genomics Spatial Methods with basic Scanpy**  
...
The purpose of this notebook is to show how Scanpy can connect **gene expression patterns** with **physical tissue organization** in spatial transcriptomics data.
